...
basepath = 'R:\\Username\\20230621_xybas\\20230621_xonly_abs\\Module1\\sensor-7'
...
if mode[0] == '1':
    ...
    for i in range(1, x_size):
        comp_path = os.path.join(basepath, 'IMAGE00_AREA-1', 'png', 'L0_VX{:04}_VY0000'.format(i), 'L0_VX{:04}_VY0000_{}.png'.format(i, npicture-1))
        comp_name = 'L0_VX{:04}_VY0000'.format(i)
...
if mode[2] == '1':
    ...
    for i in range(x_size):
        ...
        oripath = os.path.join(basepath, 'IMAGE00_AREA-1',
                               'V{:08}_L{}_VX{:04}_VY{:04}_0_{:03}.json'.format(i, 0, i, 0, npicture))
        ...
        #ファイルの移動
        stat_path = os.path.join(out_path, 'L0_VX{:04}_VY0000_stats.csv'.format(i))
