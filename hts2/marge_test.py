...
img_base = 'Q:/Username/20230914_Ali2/0020/IMAGE'

VVH = 'Q:/Username/20230914_Ali2/0020/ValidViewHistory.json'
with open(VVH) as f:
...
#         aff_path = os.path.join('Q:/Username/affine_param', '{}-{:02}_aff.csv'.format(module, sensor))
#         pq_path = os.path.join('Q:/Username/affine_param', '{}-{:02}_pq.csv'.format(module, sensor))
