...
plt.plot(x2, radial1, marker='o', mec='b', mfc='None', ms=8, label='GRAINE2018(HTS) radial', linestyle="None")
plt.plot(x2, lateral1, marker='s', mec='b', mfc='None', ms=8, label='GRAINE2018(HTS) lateral', linestyle="None")

plt.plot(x2, radial2, marker='^', mec='r', mfc='None', ms=8, label='GRAINE2023(HTS-2) radial', linestyle="None")
plt.plot(x2, lateral2, marker='v', mec='r', mfc='None', ms=8, label='GRAINE2023(HTS-2) lateral', linestyle="None")
