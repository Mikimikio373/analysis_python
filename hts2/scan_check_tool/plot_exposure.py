...
scaned_ara_view = min(len(ex_l0[0]), len(ex_l1[0]))
...
hist_return0 = ax3.hist(flat_not_l0, histtype='step', bins=100, range=(1, 1000), color='w', ec='r')
...
hist_return1 = ax4.hist(flat_not_l1, histtype='step', bins=100, range=(1, 1000), color='w', ec='b')
textbox(ax4, flat_not_l1, 1000, max(hist_return1[0]))

# plt.show()
plt.savefig(os.path.join(out_path, 'scan_area_excount.png'), dpi=300)
